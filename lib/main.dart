...
void main() async {
  ...
  // ✅ DEPRECATED API REMOVED - Bu satırlar artık gerekli değil
  // await SystemChrome.setEnabledSystemUIMode(
  //   SystemUiMode.immersiveSticky,
  //   overlays: []
  // );
  
  // ✅ Modern SystemUIOverlayStyle (sadece başlangıç için)
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    // ✅ Modern edge-to-edge implementation in theme
    ...
    return MaterialApp(
      ...
      // ✅ DEPRECATED AnnotatedRegion REMOVED - Modern approach in theme
...
// ✅ UPDATED FullScreenHelper (Modern approach)
class FullScreenHelper {
  static void enableFullScreen() {
    // Modern edge-to-edge yaklaşımı
    SystemChrome.setSystemUIOverlayStyle(
      const SystemUiOverlayStyle(
        statusBarColor: Colors.transparent,
        systemNavigationBarColor: Colors.transparent,
